...
![User interface . Source: [CASA0023 week6 lecture](https://andrewmaclachlan.github.io/CASA0023-lecture-5/#31)](img/week6/user%20interface.png){width="652"}
...
-   **Geometry operations (e.g. spatial operations)**
    ...
    -   Zonal statistics
        ...
        -   average temperature per neighbourhood/region
...
-   Dataset Availability: 2002-06-15T00:00:00Z--2022-12-12T00:00:00
...
![NAIP. Source: [NAIP in GEE](https://developers.google.com/earth-engine/datasets/catalog/USDA_NAIP_DOQQ#description)](img/week6/High_resolution.png){width="674"}
...
-   land surface **diagnostics** 陆地表面**诊断**
