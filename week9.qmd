...
-   **Phase in SAR:**
    ...
    -   [*"Phase change means ground move"*]{.underline}
...
-   VV (Vertical-Vertical): In this polarization state, both the [transmitted and received]{.underline} radar waves have their electric field vectors oriented vertically, **perpendicular to the Earth's surface**.
